...
namespace Yatzy
{
    ...
    public class DiceCup
    {
        ...
        public List<int> DiceFaceValues
        {
            get
            {
                List<int> diceFaceValues = new List<int>();

                foreach (Die d in _dice)
                {
                    diceFaceValues.Add(d.Value);
                }
        ...
        /// <summary>
        /// Returns the dice face values as (facevalue, count) pairs.

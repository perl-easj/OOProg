namespace SWCClasses.Games.RolePlay
{
    /// <summary>
    ...
    public class Character
    {
        ...
        {
            int damage = Numerics.RandomNumbers.Generate(_minDamage, _maxDamage);
        ...
        private int DealDamageModify(int dealtDamage)
        {
            ...
            if (Numerics.RandomNumbers.BelowPercentage(DealDamageModifyChance))
            {
        ...
        private int ReceiveDamageModify(int receivedDamage)
        {
            ...
            if (Numerics.RandomNumbers.BelowPercentage(ReceiveDamageModifyChance))
            {

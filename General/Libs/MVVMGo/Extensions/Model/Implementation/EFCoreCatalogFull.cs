...
namespace Extensions.Model.Implementation
{
    ...
    /// </summary>
    public abstract class EFCoreCatalogFull<TDbContext, TDomainData, TViewData, TPersistableData> : PersistableCatalogFull<TDomainData, TViewData, TPersistableData>
        ...
        where TViewData : IStorable
    {
        protected EFCoreCatalogFull(KeyManagementStrategyType kms)
            : base(new InMemoryCollection<TDomainData>(), 
                   new ConfiguredEFCoreSource<TDbContext, TPersistableData>(), 

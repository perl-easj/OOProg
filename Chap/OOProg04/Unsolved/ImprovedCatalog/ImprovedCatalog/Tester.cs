...
namespace ImprovedCatalog
{
    public class Tester
    {
        ...
        public void Run()
        {
            ...
            // The below section cannot be properly executed before you have:
            // 1) Changed the type of the properties in DomainModel to Catalog<...>
            ...
            // The below section cannot be properly executed before you have:
            // 1) Changed the type of the properties in DomainModel to IndexableCatalog<...>
            // 2) Implemented the index operator correctly in IndexableCatalog
            ...
            // The below section cannot be properly executed before you have:
            // 1) Changed the type of the properties in DomainModel to EnumerableCatalog<...>
            // 2) Implemented the GetEnumerator() method correctly in EnumerableCatalog
        ...
        ///    by invoking the All property.
        /// 2) Manually iterate over the collection returned by All.
        /// </summary>

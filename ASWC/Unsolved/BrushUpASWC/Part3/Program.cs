...
namespace Part3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("All Wizards with at least 260 health points:");
            ...
            Console.WriteLine("All Wizards with a name longer than seven letters:");
            foreach (Wizard w in wizardRep.AllWizards) // This is wrong, of course...
            {
                Console.WriteLine(w);
            }
            ...
            Console.WriteLine("All Wizards dealing at least 48,5 points of damage:");
            foreach (Wizard w in wizardRep.AllWizards) // This is wrong, of course...
            {
                Console.WriteLine(w);
            }

...
namespace Part1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // 1) Create a Beast object
            Beast aBeast = new Beast("Dragon", 250);

            // 2) Create some Wizard and Hunter objects
            ...
            // 3) Create a List object, into which I can insert Wizard and Hunter objects.


            // 4) Let each of the Wizard/Hunters in the List deal damage to the Beast


            // 5) Check if the Beast is dead or not, and announce the outcome.
